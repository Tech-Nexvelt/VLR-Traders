...
export default function MobileStickyBar() {
  ...
  const phoneDisplay = settings?.phone || settings?.salesPhone || "+91 99128 21118";
  ...
  return (
    <div className={styles.bar} role="complementary" aria-label="Quick contact actions" id="mobile-sticky-bar">
      {/* ── Call Now ───────────────────────────────────────── */}
      <a
        href={getCallUrl(phoneRaw)}
