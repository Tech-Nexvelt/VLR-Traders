...
// ============================================================
// GhostFibers — React Bits (https://reactbits.dev)
// Ported to TypeScript for this project. Shader/animation logic is
// unchanged from upstream; added a try/catch around WebGL2 init so a
// decorative background can never crash the page it sits behind.
// ============================================================
...
const GhostFibers = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // WebGL2 unavailable — skip silently, this is a decorative background.
      return;
    }
  ...
  useEffect(() => {
    ...
    const uniforms = context.program.uniforms as any;
